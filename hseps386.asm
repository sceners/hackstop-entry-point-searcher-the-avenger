...
PROCESA_1:
		...
		PUSH	  AX			;
		sub	  ax,502h		;
                BIN_A_HEX AX,ROTULO1            ;
		MOV	  DX,OFFSET PAR1	;
		CALL	  IMP			;
		POP	  AX			;
		sub	  ax,380h		;
                BIN_A_HEX AX,ROTULO2            ;
		MOV	  DX,OFFSET PAR2	;
		CALL	  IMP			;
CIERRA:
...
ROTULO          DB      0,0,0,0,13,10,13,10,'$'
PAR1		DB	'The First Patch is Located at: '
ROTULO1         DB      0,0,0,0,13,10,13,10,'$'
PAR2		DB	'The Second Patch is Located at: '
ROTULO2         DB      0,0,0,0
Tito		DB	13,10,13,10,'$'
SIN_PARAMETRO   DB      13,10,13,10
                DB      'ERROR, no se especific¢ el nombre del Archivo .....'
		DB	13,10
		DB	"Syntax   'HSEPS386 File.EXE'"
                DB      7,13,10,13,10,'$'
BUF_LCOM        DB      30 DUP(0)
BAJA            DB      13,10,13,10,13,10,'$'
NOMBRE          DB      13,10,'HS386 1.18b70 Entry Point Searcher',13,10,'$'
